...
int main(void)
{
    ...
    for (;;) {
        ...
        average_risk_level = calculate_risk_percent(light_level, resistance_level);
        risk_level = average_risk_level;
        if (raw_risk_level > average_risk_level) {
