...
#define LED_UPDATE_PERIOD_MS SAMPLE_PERIOD_MS
...
int main(void)
{
    ...
    for (;;) {
        ...
        raw_risk_level = calculate_risk_percent(light_raw, resistance_raw);
        filtered_risk_level = calculate_risk_percent(light_level, resistance_level);
        risk_level = filtered_risk_level;
        risk_text = risk_status_text(raw_risk_level);
